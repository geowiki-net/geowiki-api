...
describe("Filter sets with relations, compile", function () {
  ...
  it ('nwr[amenity];(node(w);-node(1);)', function () {
    var f = new Filter('nwr[amenity];(node(w);-node(1);)')
    ...
    assert.equal(f.toString(), 'nwr["amenity"];(node(w);-node(id:1););')
    assert.equal(f.toQl(), 'nwr["amenity"];(node(w);-node(id:1););')
    assert.equal(f.toQl({ setsUseStatementIds: true }), 'nwr["amenity"]->._1;(node(w._1)->._3;-node(id:1)->._4;)->._2;')
    assert.equal(f.toQuery(), '(nwr._3;-nwr._4;)->._2;')
    assert.equal(f.toQuery({ statement: 1 }), 'nwr["amenity"]->._1;')
    assert.deepEqual(f.recurse(), [
      { id: 1, properties: 5, type: 'w' }
    ])
    ...
    assert.deepEqual(f.derefSets(), [
      { type: 'node', filters: [], recurse:
        ...
        diff: [ { "filters": [ { "fun": "id", "value": [ 1 ] } ], "type": "node" } ]
      }
    ])
    var r = f.cacheDescriptors()
    assert.deepEqual(r, [
      { id: 'nwr["amenity"](properties:5)->._1;(node(w._1)(properties:0);-node(properties:0)(id:1);)',
        recurse: [
          { id: 'nwr["amenity"](properties:5)->._1;(node(w._1)(properties:0);-node(properties:0)(id:1);)->._1;nwr["amenity"](bn._1)(properties:5)' }
        ]
      }
    ])
  })
  it ('nwr[amenity]->.a;(node(w.a);-node(w.a)(1);)', function () {
    var f = new Filter('nwr[amenity]->.a;(node(w.a);-node(w.a)(1);)')
    ...
    assert.equal(f.toString(), 'nwr["amenity"]->.a;(node(w.a);-node(w.a)(id:1););')
    assert.equal(f.toQl(), 'nwr["amenity"]->.a;(node(w.a);-node(w.a)(id:1););')
    assert.equal(f.toQl({ setsUseStatementIds: true }), 'nwr["amenity"]->._1;(node(w._1)->._3;-node(w._1)(id:1)->._4;)->._2;')
    assert.equal(f.toQuery(), '(nwr._3;-nwr._4;)->._2;')
    assert.equal(f.toQuery({ statement: 1 }), 'nwr["amenity"]->._1;')
    assert.deepEqual(f.recurse(), [
      { id: 1, properties: 5, type: 'w' }
    ...
    assert.deepEqual(f.derefSets(), [
      { type: 'node', filters: [], recurse:
        ...
        diff: [ { "filters": [ { "fun": "id", "value": [ 1 ] } ], "type": "node", recurse:
        [
          { recurseType: 'w', type: 'nwr', filters: [ { key: 'amenity', op: 'has_key' } ] }
        ]} ]
      }
    ...
    var r = f.cacheDescriptors()
    assert.deepEqual(r, [
      { id: 'nwr["amenity"](properties:5)->._1;(node(w._1)(properties:0);-node(w._1)(properties:0)(id:1);)',
        recurse: [
          { id: 'nwr["amenity"](properties:5)->._1;(node(w._1)(properties:0);-node(w._1)(properties:0)(id:1);)->._1;nwr["amenity"](bn._1)(properties:5)' }
        ]
      }
    ])
  })
  it ('nwr[amenity]->.a;(node;-node(w.a)(1);)', function () {
    var f = new Filter('nwr[amenity]->.a;(node;-node(w.a)(1);)')
    ...
    assert.equal(f.toString(), 'nwr["amenity"]->.a;(node;-node(w.a)(id:1););')
    assert.equal(f.toQl(), 'nwr["amenity"]->.a;(node;-node(w.a)(id:1););')
    assert.equal(f.toQl({ setsUseStatementIds: true }), 'nwr["amenity"]->._1;(node->._3;-node(w._1)(id:1)->._4;)->._2;')
    assert.equal(f.toQuery(), '(nwr._3;-nwr._4;)->._2;')
    assert.equal(f.toQuery({ statement: 1 }), 'nwr["amenity"]->._1;')
    assert.deepEqual(f.recurse(), [
      { id: 1, properties: 5, type: 'w' }
    ...
    var r = f.cacheDescriptors() // TODO: wrong!!!
    assert.deepEqual(r, [
      { id: 'nwr["amenity"](properties:5)->._1;(node(properties:0);-node(w._1)(properties:0)(id:1);)',
        recurse: [
          { id: 'nwr["amenity"](properties:5)->._1;(node(properties:0);-node(w._1)(properties:0)(id:1);)->._1;nwr["amenity"](bn._1)(properties:5)' }
        ]
      }
    ])
  })
  it ('nwr[amenity]->.a;nwr[shop]->.b;(node(w.a);-node(w.b);)', function () {
    var f = new Filter('nwr[amenity]->.a;nwr[shop]->.b;(node(w.a);-node(w.b);)')
    ...
    assert.equal(f.toString(), 'nwr["amenity"]->.a;nwr["shop"]->.b;(node(w.a);-node(w.b););')
    assert.equal(f.toQl(), 'nwr["amenity"]->.a;nwr["shop"]->.b;(node(w.a);-node(w.b););')
    assert.equal(f.toQl({ setsUseStatementIds: true }), 'nwr["amenity"]->._1;nwr["shop"]->._2;(node(w._1)->._4;-node(w._2)->._5;)->._3;')
    assert.equal(f.toQuery(), '(nwr._4;-nwr._5;)->._3;')
    assert.equal(f.toQuery({ statement: 1 }), 'nwr["amenity"]->._1;')
    assert.deepEqual(f.recurse(), [
      { id: 1, properties: 5, type: 'w' },
    ...
    assert.deepEqual(f.derefSets(), [
      { type: 'node', filters: [], recurse:
        ...
        diff: [ { "filters": [], "type": "node", recurse:
        [
          { recurseType: 'w', type: 'nwr', filters: [ { key: 'shop', op: 'has_key' } ] }
        ]} ]
      }
    ])
    var r = f.cacheDescriptors()
    assert.deepEqual(r, [
      { id: 'nwr["amenity"](properties:5)->._1;nwr["shop"](properties:5)->._2;(node(w._1)(properties:0);-node(w._2)(properties:0);)',
        recurse: [
          { id: 'nwr["amenity"](properties:5)->._1;nwr["shop"](properties:5)->._2;(node(w._1)(properties:0);-node(w._2)(properties:0);)->._1;nwr["amenity"](bn._1)(properties:5)' },
          { id: 'nwr["amenity"](properties:5)->._1;nwr["shop"](properties:5)->._2;(node(w._1)(properties:0);-node(w._2)(properties:0);)->._2;nwr["shop"](bn._2)(properties:5)' }
        ]
      }
    ])
  })
  ...
  it ('relation[building];way(r:"");', function () {
    var f = new Filter('relation[building];way(r:"")')
    ...
    assert.deepEqual(f.def, [
      ...
      [
        {"type":"way"},
        {"recurse":"r","inputSet": "_","role":""}
      ]
    ])
    assert.equal(f.toString(), 'relation["building"];way(r:"");')
    assert.equal(f.toQl(), 'relation["building"];way(r:"");')
    assert.equal(f.toQl({ setsUseStatementIds: true }), 'relation["building"]->._1;way(r._1:"")->._2;')
    assert.equal(f.toQuery(), 'way(r._1:"")->._2;')
    assert.equal(f.toQuery({ statement: 1 }), 'relation["building"]->._1;')
    assert.deepEqual(f.recurse(), [
      { id: 1, properties: 5, role: '', type: 'r' }
    ])
    assert.deepEqual(f.recurse({ statement: 2 }), [
      { id: 1, properties: 5, role: '', type: 'r' }
    ])
    ...
    assert.deepEqual(f.derefSets(), [
      { type: "way", filters: [], recurse: [
        { recurseType: "r", role: "", type: "relation", filters: [ { "key": "building", "op": "has_key" } ] }
      ] }
    ])
    var r = f.cacheDescriptors()
    assert.deepEqual(r, [
    ...
    describe('initalize', function () {
      ...
      it('recurse down', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
      ...
      it('nodes of way', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'way["highway"](properties:13)->._2;node(w._2)(properties:0)',
            recurse: [{
              id: 'way["highway"](properties:13)->._2;node(w._2)(properties:0)->._2;way["highway"](bn._2)(properties:13)',
      ...
      it('nodes of way, chain query', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'way["highway"](properties:13)->._2;node["highway"](w._2)(properties:1)',
            recurse: [{
              id: 'way["highway"](properties:13)->._2;node["highway"](w._2)(properties:1)->._2;way["highway"](bn._2)(properties:13)',
              bounds:{"type":"Polygon","coordinates":[[[16.33833,48.19821],[16.33854,48.19821],[16.33854,48.1983],[16.33833,48.1983],[16.33833,48.19821]]]}
            }]
          }]
        }, done)
      ...
      it('nodes of ways of relations', function (done) {
        ...
        test({
          ...
          expectedCacheDescriptors: [{
            id: 'relation["route"="bus"](properties:13)->._2;way(r._2)(properties:4)->._3;node(w._3)(properties:0)',
            recurse: [{
              id: 'relation["route"="bus"](properties:13)->._2;way(r._2)(properties:4)->._3;node(w._3)(properties:0)->._3;way(bn._3)(properties:4)',
              recurse: [{
                id: 'relation["route"="bus"](properties:13)->._2;way(r._2)(properties:4)->._3;node(w._3)(properties:0)->._3;way(bn._3)(properties:4)->._2;relation["route"="bus"](bw._2)(properties:13)',
      ...
      it('nodes of highway and railway ways', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            "id": 'way["highway"](properties:13)->._2;way["railway"](properties:13)->._3;node(w._2)(w._3)(properties:0)',
            recurse: [{
              id: 'way["highway"](properties:13)->._2;way["railway"](properties:13)->._3;node(w._2)(w._3)(properties:0)->._2;way["highway"](bn._2)(properties:13)',
              bounds: {"type":"Polygon","coordinates":[[[16.33833,48.19821],[16.33854,48.19821],[16.33854,48.1983],[16.33833,48.1983],[16.33833,48.19821]]]}
            }, {
              id: 'way["highway"](properties:13)->._2;way["railway"](properties:13)->._3;node(w._2)(w._3)(properties:0)->._3;way["railway"](bn._3)(properties:13)',
              bounds: {"type":"Polygon","coordinates":[[[16.33833,48.19821],[16.33854,48.19821],[16.33854,48.1983],[16.33833,48.1983],[16.33833,48.19821]]]}
            }]
          }]
        }, done)
      ...
      it('nodes of highway and railway ways 2', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'way["railway"](properties:13)->._4;way["highway"](properties:13)->._2;node(w._4)(w._2)(properties:0)',
            recurse: [{
              id: 'way["railway"](properties:13)->._4;way["highway"](properties:13)->._2;node(w._4)(w._2)(properties:0)->._4;way["railway"](bn._4)(properties:13)',
              bounds: {"type":"Polygon","coordinates":[[[16.33833,48.19821],[16.33854,48.19821],[16.33854,48.1983],[16.33833,48.1983],[16.33833,48.19821]]]}
            }, {
              id: 'way["railway"](properties:13)->._4;way["highway"](properties:13)->._2;node(w._4)(w._2)(properties:0)->._2;way["highway"](bn._2)(properties:13)',
              bounds: {"type":"Polygon","coordinates":[[[16.33833,48.19821],[16.33854,48.19821],[16.33854,48.1983],[16.33833,48.1983],[16.33833,48.19821]]]}
            }]
          }]
        }, done)
      ...
      it('recurse up', function (done) {
        ...
        test({
          ...
          expectedCacheDescriptors: [{
            ...
            id: 'node["highway"](properties:9)->._2;way(bn._2)(properties:4)',
            recurse: [{
              id: 'node["highway"](properties:9)->._2;way(bn._2)(properties:4)->._2;node["highway"](w._2)(properties:9)',
              bounds: {"type":"Polygon","coordinates":[[[16.33901,48.19839],[16.33902,48.19839],[16.33902,48.1984],[16.33901,48.1984],[16.33901,48.19839]]]}
            }]
          }, {
            id: 'node["highway"](properties:9)->._2;relation(bn._2)(properties:4)',
            recurse: [{
              id: 'node["highway"](properties:9)->._2;relation(bn._2)(properties:4)->._2;node["highway"](r._2)(properties:9)',
              bounds: {"type":"Polygon","coordinates":[[[16.33901,48.19839],[16.33902,48.19839],[16.33902,48.1984],[16.33901,48.1984],[16.33901,48.19839]]]}
            }]
          },   {
            id: 'node["highway"](properties:9)->._2;way(bn._2)(properties:4)->._2;relation(bw._2)(properties:4)',
            recurse: [{
              id: 'node["highway"](properties:9)->._2;way(bn._2)(properties:4)->._2;relation(bw._2)(properties:4)->._2;way(r._2)(properties:4)',
              recurse: [{
                id: 'node["highway"](properties:9)->._2;way(bn._2)(properties:4)->._2;relation(bw._2)(properties:4)->._2;way(r._2)(properties:4)->._2;node["highway"](w._2)(properties:9)',
              bounds: {"type":"Polygon","coordinates":[[[16.33901,48.19839],[16.33902,48.19839],[16.33902,48.1984],[16.33901,48.1984],[16.33901,48.19839]]]}
              }],
            }]
          }]
      ...
      it('inner members of buildings', function (done) {
        ...
        test({
          ...
          ignoreMissing: [ "w199911274", "w199911275" ], // TODO: create when loading from file?
          expectedSubRequestCount: 1,
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'relation["building"](properties:13)->._2;way(r._2:"inner")(properties:0)',
            recurse: [{
              id: 'relation["building"](properties:13)->._2;way(r._2:"inner")(properties:0)->._2;relation["building"](bw._2:"inner")(properties:13)',
      ...
      it('all members of buildings', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'relation["building"](properties:13)->._2;way(r._2)(properties:0)',
            recurse: [{
              id: 'relation["building"](properties:13)->._2;way(r._2)(properties:0)->._2;relation["building"](bw._2)(properties:13)',
              bounds: {"type":"Polygon","coordinates":[[[16.3399,48.19853],[16.34236,48.19853],[16.34236,48.19919],[16.3399,48.19919],[16.3399,48.19853]]]}
            }]
          }]
        }, done)
      ...
      it('all buildings', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount: 1,
          expectedCacheDescriptors: [{
            id: 'relation["building"](properties:9)',
      ...
      it('buildings with inner members', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'way(properties:8)->._2;relation["building"](bw._2:"inner")(properties:5)',
            recurse: [{
              id: 'way(properties:8)->._2;relation["building"](bw._2:"inner")(properties:5)->._2;way(r._2:"inner")(properties:8)',
              bounds: {"type":"Polygon","coordinates":[[[16.3399,48.19853],[16.34236,48.19853],[16.34236,48.19919],[16.3399,48.19919],[16.3399,48.19853]]]}
            }]
          }]
        }, done)
    ...
    describe('check varying bounding boxes', function () {
      it('route members', function (done) {
        ...
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'relation["route"="tram"](properties:13)->._2;way["railway"](r._2)(properties:1)',
            recurse: [{
              id: 'relation["route"="tram"](properties:13)->._2;way["railway"](r._2)(properties:1)->._2;relation["route"="tram"](bw._2)(properties:13)',
      ...
      it('route members (cached)', function (done) {
        test({
          ...
          expectedSubRequestCount2nd: 1, // TODO: parent bbox?
          expectedCacheDescriptors: [{
            id: 'relation["route"="tram"](properties:13)->._1;way["railway"](r._1)(properties:1)',
            recurse: [{
              id: 'relation["route"="tram"](properties:13)->._1;way["railway"](r._1)(properties:1)->._1;relation["route"="tram"](bw._1)(properties:13)',
      ...
      it('or1', function (done) {
        test({
          ...
          expectedCacheDescriptors: [{
            ...
            "id": 'way["highway"="secondary"](properties:13)->._3;node(w._3)(properties:0)',
            "recurse": [{
              id: 'way["highway"="secondary"](properties:13)->._3;node(w._3)(properties:0)->._3;way["highway"="secondary"](bn._3)(properties:13)',
              bounds: {"type":"Polygon","coordinates":[[[16.33835,48.19821],[16.33841,48.19821],[16.33841,48.19827],[16.33835,48.19827],[16.33835,48.19821]]]}
            }]
          }]
        }, done)
...
function test (options, callback) {
  ...
  options.queryOptions.properties = options.queryOptions.properties ?? 0
